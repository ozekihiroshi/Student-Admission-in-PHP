...
<div class="confirmation-page">
    ...
    <ul>
        <li><strong>Last Name:</strong> <?php echo esc_html($sname); ?></li>
        <li><strong>First Name:</strong> <?php echo esc_html($gname); ?></li>
        ...
        <li><strong>Class:</strong> <?php echo esc_html($class); ?></li>
        <li><strong>Shift:</strong> <?php echo esc_html($shift); ?></li>
        <li><strong>Gender:</strong> <?php echo esc_html($gender); ?></li>
        <li><strong>Blood Group:</strong> <?php echo esc_html($blgroup); ?></li>
        <li><strong>Division:</strong> <?php echo esc_html($division); ?></li>
        <li><strong>Age:</strong> <?php echo esc_html($age); ?></li>
    </ul>
